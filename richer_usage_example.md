...
This step-by-step example shows how to spin a 9 node Cassandra cluster in 3 different availability zones with 3 seed nodes.
...
```
    # export DM_API=http://master:6666
    # ./dse-mesos.sh add cassandra-node 0..8 --constraints "hostname=unique,az=groupBy:3" --cluster-name example
Added tasks 0..8
...
cluster:
  task:
    ...
    seed: false
    constraints: hostname=unique,az=groupBy:3
  ...
  task:
    ...
    # ./dse-mesos.sh update 0..2 --seed true
Updated tasks 0..2
...
cluster:
  task:
    ...
    cluster name: example
    seed: true
    seeds: ip-172-20-3-55.node.thecluster
    constraints: hostname=unique,az=groupBy:3
    runtime:
      task id: cassandra-node-0-1446640496666
      slave id: 20151103-122609-1059591340-5050-11958-S1
      executor id: cassandra-node-0-1446640496693
  ...
  task:
    ...
    constraints: hostname=unique,az=groupBy:3
    runtime:
      task id: cassandra-node-1-1446640526698
      slave id: 20151103-122609-1059591340-5050-11958-S9
      executor id: cassandra-node-1-1446640526698
  ...
  task:
    ...
    cluster name: example
    seed: true
    seeds: ip-172-20-3-55.node.thecluster,ip-172-20-45-222.node.thecluster
    constraints: hostname=unique,az=groupBy:3
    runtime:
      task id: cassandra-node-2-1446640640826
      slave id: 20151103-122609-1059591340-5050-11958-S3
      executor id: cassandra-node-2-1446640640826
  ...
  task:
    ...
    cluster name: example
    seed: false
    seeds: ip-172-20-17-103.node.thecluster,ip-172-20-3-55.node.thecluster,ip-172-20-45-222.node.thecluster
    constraints: hostname=unique,az=groupBy:3
    runtime:
      task id: cassandra-node-3-1446640730940
      slave id: 20151103-122609-1059591340-5050-11958-S5
      executor id: cassandra-node-3-1446640730940
  ...
  task:
    ...
    constraints: hostname=unique,az=groupBy:3
    runtime:
      task id: cassandra-node-4-1446640821042
      slave id: 20151103-122609-1059591340-5050-11958-S8
      executor id: cassandra-node-4-1446640821043
  ...
  task:
    ...
    constraints: hostname=unique,az=groupBy:3
    runtime:
      task id: cassandra-node-5-1446640951197
      slave id: 20151103-122609-1059591340-5050-11958-S0
      executor id: cassandra-node-5-1446640951197
  ...
  task:
    ...
    constraints: hostname=unique,az=groupBy:3
    runtime:
      task id: cassandra-node-6-1446641055325
      slave id: 20151103-122609-1059591340-5050-11958-S4
      executor id: cassandra-node-6-1446641055325
  ...
  task:
    ...
    constraints: hostname=unique,az=groupBy:3
    runtime:
      task id: cassandra-node-7-1446641181471
      slave id: 20151103-122609-1059591340-5050-11958-S7
      executor id: cassandra-node-7-1446641181471
  ...
  task:
    ...
    constraints: hostname=unique,az=groupBy:3
    runtime:
      task id: cassandra-node-8-1446641265562
      slave id: 20151103-122609-1059591340-5050-11958-S6
      executor id: cassandra-node-8-1446641265562
